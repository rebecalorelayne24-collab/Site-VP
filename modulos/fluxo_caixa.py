...
def ler_extrato_com_gemini(texto_pdf):
    """Envia o texto do extrato usando modelos ativos e estáveis com tratamento de erros."""
    ...
    try:
        ...
        Regras:
        - data: YYYY-MM-DD (se não houver ano no texto, use {datetime.now().year})
        ...
        # Trata limpeza de blocos markdown
