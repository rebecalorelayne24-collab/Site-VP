...
@st.cache_data
def _css():
    # A string do CSS deve iniciar exatamente na margem esquerda (sem recuos) para não ativar o parser de código Markdown
...
def section_header(eyebrow, title):
    ...
    html = f"""<div class="fj-eyebrow">{eyebrow}</div>
